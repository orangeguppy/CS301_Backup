...
def lambda_handler(event, context):
    ...
    try:
        ...
        cur = conn.cursor()
        cur.execute("""SELECT id, email, first_name, last_name, status, birthdate, role FROM users WHERE id = %s""", (id))
        query_results = json.dumps(cur.fetchall())
