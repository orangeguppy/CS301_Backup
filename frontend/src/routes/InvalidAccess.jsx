        ...
        <div className="min-h-screen">
            ...
            <div className="flex text-center">
                <div className="w-auto px-16 h-36 rounded-xl justify-center text-center items-center mx-auto mt-10">
                    <h1 className="text-3xl font-bold">No authorization found.</h1>
                    {/* <p>Click <a href="/login" className="underline">here</a> to return to Login Page to sign in again</p> */}
                    <p className="mt-1 font-medium text-xl">This page is not publicly available.</p>
                    <p className="mt-1 font-medium text-xl">To access it please login first.</p>
